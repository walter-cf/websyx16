    ...
    <xsl:template match="Customers">
        ...
        <Customers>
            ...
            <xsl:for-each select="Customer">
                ...
                <xsl:if test="forcedCustomerId">
                    <sid><xsl:value-of select="forcedCustomerId" /></sid>
                </xsl:if>
                ...
                <street><xsl:value-of  select="Addresses/Invoice/StreetName"  disable-output-escaping="yes" /></street>
                <housenumber><xsl:value-of select="Addresses/Invoice/StreetNumber" /></housenumber>
                <!-- 
                <mailcountry><xsl:value-of select="Addresses/Shipping/Country" /></mailcountry>
                <xsl:if test="Addresses/Shipping/County != ''"><mailregion><xsl:value-of select="Addresses/Shipping/County" /></mailregion></xsl:if>
                <mailzip><xsl:value-of select="Addresses/Shipping/ZIP" /></mailzip>
                <mailcity><xsl:value-of select="Addresses/Shipping/City" /></mailcity>
                <mailstreet><xsl:value-of select="Addresses/Shipping/StreetName" /></mailstreet>
                <mailhousenumber><xsl:value-of select="Addresses/Shipping/StreetNumber" /></mailhousenumber>
                -->
                ...
                <customeraddresses>
                    ...
                    <customeraddress>
                        ...
                        <!--
                        <xsl:if test="$SymbolCustomerID != ''">
                            <code>UCS<xsl:value-of select="$UnasCustomerID" /></code>
                        </xsl:if>
                        -->
                        <code>UCS<xsl:value-of select="$UnasCustomerID" /></code>
                        ...
                        <street><xsl:value-of select="StreetName" /></street>
                    ...
                    <customeraddress>
                        ...
                        <code>UCA<xsl:value-of select="$UnasCustomerID" />-<xsl:value-of select="otherAddressIndex" /></code>
                        ...
                        <xsl:if test="StreetName != ''"><street><xsl:value-of select="StreetName" /></street></xsl:if>
                        <xsl:if test="not(StreetName)"><street><xsl:value-of select="Street" /></street></xsl:if>
                       
                        <xsl:if test="StreetNumber"><housenumber><xsl:value-of select="StreetNumber" /></housenumber></xsl:if>
                        ...
                        <description>UNAS Customer Other Address info - <xsl:value-of select="otherAddressIndex" /></description>
                        <deleted>0</deleted>
                    </customeraddress>
                    </xsl:for-each>
